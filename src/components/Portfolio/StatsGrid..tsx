  ...
  return (
    <div className="bg-gray-50 rounded-2xl p-2">
      ...
      <div className="flex md:grid gap-1 md:gap-4 overflow-x-auto pb-1 md:pb-0 
                      ...
                      scrollbar-thin scrollbar-thumb-[#387ED1] scrollbar-track-transparent
        ...
        {stats.map((stat, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`flex-none w-[200px] md:w-auto 
                         snap-start
                         group flex flex-col justify-between p-3 md:p-5 rounded-xl 
